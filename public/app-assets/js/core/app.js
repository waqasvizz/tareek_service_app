...
(function (window, document, $) {
  ...
  $('.nav-link-style').on('click', function () {
    ...
    if (getCurrentLayout() == 'dark-light') {
      prevLayout = 'light-layout';
    } else {
      prevLayout = 'dark-light';
    }
    ...
    // console.log('getCurrentLayout: '+getCurrentLayout());
    // console.log('prevLayout: '+prevLayout);
    ...
    setCookie("myLayout", switchToLayout, 30);
    var APP_URL = $("#url").val();
    // console.log(APP_URL);

    if (APP_URL == 'http://localhost:8000') {
      APP_URL = APP_URL + '/app-assets/images/logo';

    } else {
      APP_URL = APP_URL + '/public/app-assets/images/logo';

    }
    // console.log(APP_URL);

    if (switchToLayout == 'dark-layout') {
      $('.logo-1').attr("src", APP_URL + "/white-logo.png");
      $('.logo-2').attr("src", APP_URL + "/white-logo.png");

    } else {
      $('.logo-1').attr("src", APP_URL + "/logo.png");
      $('.logo-2').attr("src", APP_URL + "/logo.png");

    }

    // sessionStorage.setItem("myLayout", switchToLayout);
    // $('#setlayout').val(switchToLayout);
  ...
  /*function selectedThemeStyle() {
      // var switchToLayout = $('#setlayout').val();
      // var switchToLayout = 'dark-layout';
      // var switchToLayout = sessionStorage.getItem("myLayout");
      var switchToLayout = getCookie('myLayout');
      ...
      if (switchToLayout=='dark-layout'){
          ...
          // console.log('switchToLayout: '+switchToLayout);
          setLayout(switchToLayout);
      }
  }
  selectedThemeStyle();*/
  ...
  function setLayout(currentLocalStorageLayout) {
    // console.log('switchToLayout: '+getCurrentLayout());
