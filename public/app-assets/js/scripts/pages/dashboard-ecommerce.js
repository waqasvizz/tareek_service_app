...
$(window).on('load', function () {
  ...
  var $totalTodayProfitChart = document.querySelector('#total-today-profit-chart');
  ...
  var totalTodayProfitChartOptions;
  ...
  //--------------- Total Today Profit Chart ---------------
  //----------------------------------------------
  var $today_total_profit = document.querySelector('#today_total_profit');
  var today_total_profit = $today_total_profit.getAttribute("data-label");
// var today_total_profit = 15865;
  totalTodayProfitChartOptions = {
    chart: {
      type: 'donut',
      height: 200,
      toolbar: {
  ...
  totalTodayProfitChart = new ApexCharts($totalTodayProfitChart, totalTodayProfitChartOptions);
  totalTodayProfitChart.render();
