...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function eventClick(info) {
        ...
        btnDeleteEvent.on('click', function () {
            ...
            deleteDbEvent(eventToUpdate.id);
    ...
    function modifyToggler() {
        $('.fc-sidebarToggle-button')
            .empty()
            .append('<img src="public/app-assets/images/7e4f96d2-8068-4bdc-b04c-3990a38eb09d.gif" height="40px">');
    ...
    function addEvent(eventData) {
        ...
        /*   var result = [];
           ...
           for(var i in eventData)
               result.push([i, eventData [i]]);

           console.log(result);*/
        saveDbEvent(eventData);
    ...
    function updateEvent(eventData) {
        ...
        // console.log(extendedPropsToUpdate);
    ...
    updateEventBtn.on('click', function () {
        if (eventForm.valid()) {
            ...
            // console.log(eventData);
            updateDbEvent(eventData, eventToUpdate.id);
