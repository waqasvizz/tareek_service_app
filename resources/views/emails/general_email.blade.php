<section style="width: 100%;">
    <div style="
        ...
        <div style="padding: 20px 40px; position:absolute; top: 30%;">
            ...
            <p style="font-size:18px;font-family: Arial, Helvetica, sans-serif;color: #FFF;">{{ $email_data['text_line'] }}.<br></p><br>
            <p style="font-size:18px;font-family: Arial, Helvetica, sans-serif;color: #FFF;">Best Regards,</p><br>
