<section style="width: 100%;">
    <div style="
        ...
        <div style="padding: 20px 40px; position:absolute; top: 30%;">
            ...
            <p style="font-size:18px;font-family: Arial, Helvetica, sans-serif;color: #FFF;">You have got a new order on {{ config('app.name') }}.<br></p><br>
            <p style="font-size:18px;font-family: Arial, Helvetica, sans-serif;color: #FFF;">Please sign in to {{ config('app.name') }} and respond to the client.</p><br>
